package com.gumbyxgames.leankeyboard.helpers;
...
import com.gumbyxgames.leankeyboard.utils.LocaleUtility;
...
public class Helpers {
    ...
    public static String encodeURI(byte[] data) {
        try {
            ...
            return URLEncoder.encode(new String(data, StandardCharsets.UTF_8), "UTF-8").replace("+", "%20");
