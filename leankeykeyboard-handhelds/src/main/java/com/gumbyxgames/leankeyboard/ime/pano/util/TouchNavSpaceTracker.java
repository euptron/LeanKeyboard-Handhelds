package com.gumbyxgames.leankeyboard.ime.pano.util;
...
public class TouchNavSpaceTracker {
    ...
    private final PointF mPhysicalPosition;
    ...
    private final PointF mPrevPhysPosition;
    private float mSensitivity;
    private final TimeInterpolator mSensitivityInterpolator;
    ...
    private void checkForLongClick(int var1, KeyEvent event) {
        if (var1 == 23) {
            ...
            if (!this.mHandler.hasMessages(0)) {
                this.mHandler.sendMessageDelayed(msg, ViewConfiguration.getLongPressTimeout());
            }
        }
    ...
    private int getDpadDirection(final float dx, final float dy) {
        final float polar = (float) Math.atan2(-dy, dx);
    ...
    private TouchNavMotionTracker getTrackerForDevice(InputDevice device) {
        TouchNavMotionTracker var3 = this.mTouchParams.get(device.getId());
    ...
    public boolean onGenericMotionEvent(MotionEvent event) {
        if (event != null && (event.getSource() & InputDevice.SOURCE_TOUCH_NAVIGATION) == InputDevice.SOURCE_TOUCH_NAVIGATION) {
            ...
            boolean pointerUp;
            pointerUp = (action & 255) == MotionEvent.ACTION_POINTER_UP;
            ...
            switch (action & 255) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (var15 == null) {
                        ...
                        return this.mPixelListener.onUp(pe, this.getPixelX(this.mPhysicalPosition.x),
                    ...
                    if (tracker.computeVelocity()) {
                        ...
                        if (this.mPixelListener != null) {
                            ...
                            var18 = this.mPixelListener.onFling(var16, pe, sumY, sumX);
                            pointerUp = var18;
                            ...
                            if (this.mPixelListener != null) {
                                ...
                                if (this.mPixelHeight > 0.0F) {
                                    ...
                                    if (this.mPixelWidth > 0.0F) {
                                        ...
                                        sumY = this.getPixelX(this.mPhysicalPosition.x);
                                        sumX = this.getPixelY(this.mPhysicalPosition.y);
                                        var11 = this.mPixelListener.onMove(var16, pe, sumY, sumX);
                                    }
                                }
                            }
