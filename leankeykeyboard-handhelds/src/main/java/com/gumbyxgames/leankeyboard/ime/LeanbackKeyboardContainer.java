package com.gumbyxgames.leankeyboard.ime;
...
import com.gumbyxgames.leankeyboard.addons.keyboards.KeyboardManager.KeyboardData;
import com.gumbyxgames.leankeyboard.addons.theme.ThemeManager;
import com.gumbyxgames.leankeyboard.addons.voice.RecognizerIntentWrapper;
import com.gumbyxgames.leankeyboard.helpers.PermissionHelpers;
import com.gumbyxgames.leankeyboard.activity.PermissionsActivity;
import com.gumbyxgames.leankeyboard.ime.LeanbackKeyboardController.InputListener;
import com.gumbyxgames.leankeyboard.ime.voice.RecognizerView;
import com.gumbyxgames.leankeyboard.ime.voice.SpeechLevelSource;
import com.gumbyxgames.leankeyboard.activity.settings.KbLayoutActivity;
import com.gumbyxgames.leankeyboard.activity.settings.KbSettingsActivity;
import com.gumbyxgames.leankeyboard.addons.keyboards.KeyboardManager;
import com.gumbyxgames.leankeyboard.helpers.Helpers;
import com.gumbyxgames.leankeyboard.helpers.MessageHelpers;
...
public class LeanbackKeyboardContainer {
    ...
    private final Button mActionButtonView;
    ...
    private final LeanbackImeService mContext;
    private final KeyFocus mCurrKeyInfo = new KeyFocus();
    private DismissListener mDismissListener;
    private final KeyFocus mDownKeyInfo = new KeyFocus();
    ...
    private final View mKeyboardsContainer;
    private final LeanbackKeyboardView mMainKeyboardView;
    private int mMiniKbKeyIndex;
    private Keyboard mNumKeyboard;
    private final float mOverestimate;
    private final PointF mPhysicalSelectPos = new PointF(2.0F, 0.5F);
    private final PointF mPhysicalTouchPos = new PointF(2.0F, 0.5F);
    private LeanbackKeyboardView mPrevView;
    private Intent mRecognizerIntent;
    private final Rect mRect = new Rect();
    private final RelativeLayout mRootView;
    private final View mSelector;
    private final ImageView mKeySelector;
    private final Drawable mKeySelectorSquare;
    private final Drawable mKeySelectorStretched;
    private final ThemeManager mThemeManager;
    private final ScaleAnimation mSelectorAnimation;
    private final ValueAnimator mSelectorAnimator;
    private final SpeechLevelSource mSpeechLevelSource;
    private final SpeechRecognizer mSpeechRecognizer;
    private final RecognizerIntentWrapper mRecognizerIntentWrapper;
    private final LinearLayout mSuggestions;
    private final View mSuggestionsBg;
    private final HorizontalScrollView mSuggestionsContainer;
    private boolean mSuggestionsEnabled;
    private boolean mForceDisableSuggestions;
    private Keyboard mSymKeyboard;
    private final KeyFocus mTempKeyInfo = new KeyFocus();
    private final PointF mTempPoint = new PointF();
    private final boolean mTouchDown = false;
    ...
    private final RecognizerView mVoiceButtonView;
    ...
    private final AnimatorListener mVoiceEnterListener = new AnimatorListener() {
        @Override
    ...
    private final AnimatorListener mVoiceExitListener = new AnimatorListener() {
        @Override
        public void onAnimationCancel(Animator animation) {
        }
    ...
    public LeanbackKeyboardContainer(Context context) {
        ...
        mSuggestionsContainer = mRootView.findViewById(R.id.suggestions_container);
        mSuggestions = mSuggestionsContainer.findViewById(R.id.suggestions);
        mMainKeyboardView = mRootView.findViewById(R.id.main_keyboard);
        mVoiceButtonView = mRootView.findViewById(R.id.voice);
        mActionButtonView = mRootView.findViewById(R.id.enter);
        ...
        if (!focus.equals(mCurrKeyInfo) || forceFocusChange) {
            ...
            switch (focus.type) {
                case KeyFocus.TYPE_MAIN:
                    ...
                    boolean isClicked = mTouchState == TOUCH_STATE_CLICK;
    ...
    public static class KeyFocus {
        ...
        public boolean equals(Object obj) {
            if (this != obj) {
                ...
                return this.rect.equals(focus.rect);
            }
    ...
    private class VoiceIntroAnimator {
        private final AnimatorListener mEnterListener;
        private final AnimatorListener mExitListener;
