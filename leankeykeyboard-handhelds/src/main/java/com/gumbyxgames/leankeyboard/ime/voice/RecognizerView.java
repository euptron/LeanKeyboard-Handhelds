package com.gumbyxgames.leankeyboard.ime.voice;
...
import com.gumbyxgames.leankeyboard.ime.LeanbackUtils;
...
public class RecognizerView extends RelativeLayout {
    ...
    public void onFinishInflate() {
        ...
        mSoundLevels = findViewById(R.id.microphone);
        mMicButton = findViewById(R.id.recognizer_mic_button);
